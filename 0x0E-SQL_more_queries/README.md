...
## Description :house:
In this project, I learnt more about SQL queries, working with
permissoins, joins, and constraints. I understood that I can give permissions to how a database can be manipulated
or accessed.

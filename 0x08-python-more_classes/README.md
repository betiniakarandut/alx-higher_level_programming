...
OOP(Object-Oriented Programming) continue:
class methods, static methods, class vs instance attributes, and
how to use the special `__str__` and `__repr__` methods.

## Tests :heavy_check_mark:

* [tests](./tests): **No test cases needed(for this project tasks)**.

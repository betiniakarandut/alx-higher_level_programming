...
## Description :house:
In this project, I began to learn Javascript webscraping and some amazing things with nodejs.
I also practice file I/O on Node.js and using the NPM request
